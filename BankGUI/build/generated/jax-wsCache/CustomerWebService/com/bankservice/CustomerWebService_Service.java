 ...
 * 
 */
@WebServiceClient(name = "CustomerWebService", targetNamespace = "http://BankService.com/", wsdlLocation = "http://localhost:8080/BankServer/CustomerWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERWEBSERVICE_QNAME = new QName("http://BankService.com/", "CustomerWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/BankServer/CustomerWebService?wsdl");
    ...
    public CustomerWebService getCustomerWebServicePort() {
        return super.getPort(new QName("http://BankService.com/", "CustomerWebServicePort"), CustomerWebService.class);
    }
    ...
    public CustomerWebService getCustomerWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://BankService.com/", "CustomerWebServicePort"), CustomerWebService.class, features);
    }
